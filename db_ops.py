...
con = 'deploy/db/exam.db'
# con = 'C:\\Users\\Geethesh\\Documents\\GitHub\\Altreks\\db\\exam.db'
# con = 'C:\\Users\\RAJASEKAR\\Desktop\\Altreks-master\\db\\exam.db'
...
# def ViewRequests():
#     conn = sqlite3.connect('C:\\Users\\hp-pc\\Desktop\\Altreks-master\\db\\exam.db')
#     cursor = conn.execute(f"SELECT EMAIL,EDATE,ETIME,EID,SLOT from SCHEDULE")
#     lis = list()
#     for row in cursor:
#         temp = [
